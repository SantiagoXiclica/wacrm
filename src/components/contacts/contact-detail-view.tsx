...
export function ContactDetailView({
  ...
  async function saveCustomFields() {
    ...
    try {
      ...
      toast.error(t('failedToSaveFields'));
    }
  ...
  async function handleSendTemplate(
    ...
    try {
      ...
      if (!res.ok) {
        ...
        toast.error(t('failedToSendTemplate', { reason }));
        return;
      }

      toast.success(t('templateSent', { name: template.name }));
    } catch (err) {
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder={t('enterField', { name: field.field_name })}
