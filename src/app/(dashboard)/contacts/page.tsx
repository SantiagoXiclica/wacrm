...
export default function ContactsPage() {
  ...
  async function handleBulkDelete() {
    ...
    if (error) {
      toast.error(t('failedToDeleteSelected'));
    } else {
      toast.success(t('deletedSelected', { count: ids.length }));
      setSelected(new Set());
      fetchContacts();
    }
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              {t("deleteBody", { name: deleteTarget?.name || deleteTarget?.phone || "" })}
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">
              {t("deleteSelectedTitle", { count: selected.size })}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
              {t("deleteSelectedBody", { count: selected.size })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="bg-popover border-border">
            <Button
